...
import type { NpcId } from '@data/levels'
 ...
 * this must not touch npcs/ground/hittable: entities register there on mount and remove
 * themselves on unmount, and clearing here would wipe registrations that already happened.
 */
